...
for i, line in enumerate(lines):
    ...
    # 1. Skip lines 355 to 398 (TEMPLATES and getTemplate)
    if 355 <= line_num <= 398:
        continue
    
    # 2. Skip lines 1561 to 1824 (renderResumeHTML, MODULE_ICONS, and renderModuleHTML)
    if 1561 <= line_num <= 1824:
        continue
    
    # Add to output
    new_lines.append(line)
    
    # 3. Inject script tags exactly after src/utils/html.js
    if 'src/utils/html.js' in line:
        new_lines.append('<script src="./src/templates/t01-classic-dense.js"></script>\n')
        new_lines.append('<script src="./src/templates/t02-modern-icon.js"></script>\n')
        new_lines.append('<script src="./src/templates/t03-minimal-ats.js"></script>\n')
        new_lines.append('<script src="./src/templates/t04-business-clean.js"></script>\n')
        new_lines.append('<script src="./src/templates/index.js"></script>\n')

with open('resume_chatgpt_stable_clean_v9.html', 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("Split templates successfully and accurately!")
